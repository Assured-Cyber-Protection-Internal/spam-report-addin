...
function debug_message(msg, callback) {
...
function onSpamReport(event) {
  debug_message("BITCH NUMBER 5", function() {
    ...
    //     Office.context.mailbox.item.notificationMessages.addAsync('phishingReport', {
